        ...
        <div class="container-fluid container-fluid--cp-100">
            <div class="row footer-widget-wrapper">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 footer-widget">
                    ...
                    <ul class="footer-widget__list">
                        <li><a href="http://127.0.0.1:8000/" class="hover-style-link">About Us</a></li>
                        <li><a href="http://127.0.0.1:8000/" class="hover-style-link">What We Do</a></li>
                        <li><a href="http://127.0.0.1:8000/" class="hover-style-link">FAQ Page</a></li>
                        <li><a href="http://127.0.0.1:8000/" class="hover-style-link">Contact Us</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 footer-widget">
                    <h6 class="footer-widget__title mb-20">Social Media</h6>
                    <ul class="footer-widget__list">
                        <li><a href="https://www.facebook.com/Gudangmusic/?locale=id_ID" class="hover-style-link">Facebook</a></li>
                        <li><a href="https://x.com/GudangMusikShop" class="hover-style-link">Twitter</a></li>
                        <li><a href="https://www.instagram.com/gudangmusikshop/" class="hover-style-link">Instagram</a></li>
                    </ul>
                </div>
        ...
        <div class="container-fluid container-fluid--cp-100">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 order-md-1 order-2">
                    <span class="copyright-text text-center text-md-start">&copy; 2025 Gudang Musik. <a  href="http://127.0.0.1:8000/" target="_blank">All Rights Reserved.</a></span>
                ...
                <div class="col-lg-6 col-md-6 order-md-2 order-1">
                    <div class="footer-bottom-social">
                        ...
                        <ul class="list footer-social-networks ">
                            <li class="item">
                                <a href="https://www.facebook.com/Gudangmusic/?locale=id_ID" target="_blank" aria-label="Twitter">
                                    <i class="social social_facebook"></i>
                                </a>
                            </li>
                            <li class="item">
                                <a href="https://x.com/GudangMusikShop" target="_blank" aria-label="Facebook">
                                    <i class="social social_twitter"></i>
                                </a>
                            </li>
                            <li class="item">
                                <a href="https://www.instagram.com/gudangmusikshop/" target="_blank" aria-label="Instagram">
